...
<div id="stats" class="container show">
  ...
  <ul>
    ...
    <li>Луна: на орбите <span class="yellow">{DATA[2][0]}</span>, достигли поверхночти <span class="yellow">{DATA[2][1]}</span></li>
    <li>В точках Лаграгжа L1/L2 системы Земля-Солнце: на орбите <span class="yellow">{DATA[3][0]}</span>, вошли в атмосферу <span class="yellow">{DATA[3][1]}</span></li>
    <li>Солнце: на орбите <span class="yellow">{DATA[4][0]}</span>, вошли в атмосферу <span class="yellow">{DATA[4][1]}</span></li>
    <li>Меркурий: на орбите <span class="yellow">{DATA[5][0]}</span>, достигли поверхночти <span class="yellow">{DATA[5][1]}</span></li>
    <li>Венера: на орбите <span class="yellow">{DATA[6][0]}</span>, вошли в атмосферу <span class="yellow">{DATA[6][1]}</span></li>
    <li>Марс: на орбите <span class="yellow">{DATA[7][0]}</span>, достигли поверхночти <span class="yellow">{DATA[7][1]}</span></li>
    <li>Юпитер: на орбите <span class="yellow">{DATA[8][0]}</span>, вошли в атмосферу <span class="yellow">{DATA[8][1]}</span></li>
    <li>Сатурн: на орбите <span class="yellow">{DATA[9][0]}</span>, вошли в атмосферу <span class="yellow">{DATA[9][1]}</span></li>
    <li>Титан: на орбите <span class="yellow">{DATA[10][0]}</span>, вошли в атмосферу <span class="yellow">{DATA[10][1]}</span></li>
    <li>Астероиды и кометы: на орбите <span class="yellow">{DATA[11][0]}</span>, достигли поверхночти <span class="yellow">{DATA[11][1]}</span></li>
  </ul>
  <p>Всего записей: <span class="yellow">{ALL}</span></p>
  </div>
  <div id="footer">
