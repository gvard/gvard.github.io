...
a1, a2, b1, b2, bins = 29, 500, 0, 210, 1500
...
plot_vert_pla(b1, b2)
plt.plot((84.2, 84.2), (b1, b2), '--k')
plt.plot((76.3, 76.3), (b1, b2), '--', color='grey')
plt.ylim(b1, b2)
plt.xlim(a1, a2)
...
plt.savefig('graph/hist-a29-500-200ml-filt-sedna.png', dpi=120)