...
a1, a2, b1, b2, bins = 0.56, 2.08, 0, 149, 3000
...
plot_vert_pla(b1, b2)
plt.plot((1.458, 1.458), (b1, b2), '--', color='grey')
plt.plot((1.133, 1.133), (b1, b2), '--', color='grey', lw=0.8)
plt.plot((1.24, 1.24), (b1, b2), '--', color='green', lw=0.8)
plt.ylim(b1, b2)
plt.xlim(a1, a2)
...
plt.savefig('graph/hist-a0.5-2-149.png', dpi=120)