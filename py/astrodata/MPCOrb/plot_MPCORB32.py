...
from plot_supply import plot_vert_pla, plot_vert_kirkwood
...
a1, a2, b1, b2, bins = 0.6, 5.4, 0, 1050, 8000
...
plt.savefig('graph/hist-a6-1050ml-filt.png', dpi=120)
